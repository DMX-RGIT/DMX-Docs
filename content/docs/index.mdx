...
DMX-docs started out as a [shadcn/ui component](https://github.com/DataMatrix-RGIT/auto-docs) but grew so large I decided it's best to split it into a package instead.
